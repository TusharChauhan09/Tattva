    ...
    <View style={styles.screen}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContent}>
          <Text style={styles.title}>Smart Nutrition Tracking</Text>
          <Text style={styles.description}>
            Track your meals, monitor macros, and receive AI-driven dietary
            recommendations to fuel your fitness transformation.
          </Text>
        </View>
      </View>
