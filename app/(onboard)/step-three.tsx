  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.textContent}>
          ...
          <Text style={styles.description}>
            Monitor your fitness journey with real-time analytics, body metrics
            tracking, and AI-generated insights to keep you motivated.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.bottomNav}>
        <GradientButton title="Get Started" onPress={handleGetStarted} />
      </View>
    </View>
  );
}
